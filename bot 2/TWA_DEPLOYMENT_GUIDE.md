...
Run the dashboard on a public HTTPS URL and open it directly inside your Telegram bot as a Telegram Mini App.
...
That button opens the dashboard inside Telegram using `WebAppInfo`, which makes it a Telegram Mini App.
...
That makes the dashboard open directly from the bot menu as a Telegram Mini App.
